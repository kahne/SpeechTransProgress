...
- [arXiv] [Multilingual Speech-to-Speech Translation into Multiple Target Languages](https://arxiv.org/pdf/2307.08655.pdf)
...
- [ACL] [Attention as a guide for Simultaneous Speech Translation](https://arxiv.org/pdf/2212.07850.pdf)
...
- [ACL Findings] [Joint Speech Transcription and Translation: Pseudo-Labeling with Out-of-Distribution Data](https://aclanthology.org/2023.findings-acl.483.pdf)
...
- [EACL Findings] [Generating Synthetic Speech from SpokenVocab for Speech Translation](https://arxiv.org/pdf/2210.08174.pdf)
- [AAAI] [Improving End-to-end Speech Translation by Leveraging Auxiliary Speech and Text Data](https://arxiv.org/pdf/2212.01778.pdf)
...
- [EMNLP Findings] [Does Simultaneous Speech Translation need Simultaneous Models?](https://arxiv.org/pdf/2204.03783.pdf)
...
- [INTERSPEECH] [Blockwise Streaming Transformer for Spoken Language Understanding and Simultaneous Speech Translation](https://arxiv.org/pdf/2204.08920.pdf)
- [INTERSPEECH] [Combining Spectral and Self-Supervised Features for Low Resource Speech Recognition and Translation](https://arxiv.org/pdf/2204.02470.pdf)
- [INTERSPEECH] [Large-Scale Streaming End-to-End Speech Translation with Neural Transducers](https://arxiv.org/pdf/2204.05352.pdf)
- [INTERSPEECH] [Speech Segmentation Optimization using Segmented Bilingual Speech Corpus for End-to-end Speech Translation](https://arxiv.org/pdf/2203.15479.pdf)
- [INTERSPEECH] [Leveraging unsupervised and weakly-supervised data to improve direct speech-to-speech translation](https://arxiv.org/pdf/2203.13339.pdf)
- [INTERSPEECH] [SHAS: Approaching optimal Segmentation for End-to-End Speech Translation](https://arxiv.org/pdf/2202.04774.pdf)
...
- [INTERSPEECH] [M-Adapter: Modality Adaptation for End-to-End Speech-to-Text Translation](https://arxiv.org/pdf/2207.00952.pdf)
...
- [LREC] [CVSS Corpus and Massively Multilingual Speech-to-Speech Translation](https://arxiv.org/pdf/2201.03713.pdf)
- [LREC] [LibriS2S: A German-English Speech-to-Speech Translation Corpus](https://arxiv.org/pdf/2204.10593.pdf)
